...
import { autumnKioskCartridge } from './cartridge/autumnKiosk';
import { isabelIdentity } from './identity/isabel';
...
export default function PortraitQuest() {
  ...
  const cartridge = autumnKioskCartridge;
  const identity = isabelIdentity;
